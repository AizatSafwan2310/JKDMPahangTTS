    ...
    <table>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='8'>No staff found in LTSAS department.</td></tr>";
            }
            $conn->close();
            ?>
        </tbody>
