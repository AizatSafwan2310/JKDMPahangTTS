...
// SQL query to fetch staff from PERKASTAMAN department
$sql = "SELECT firstName, lastName, workposition, icnumber, email, phoneNumber, department 
        FROM jkdmregister 
        WHERE department = 'PERKASTAMAN'
        ORDER BY department, 
        CASE 
    ...
    <table>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='8'>No staff found in PERKASTAMAN department</td></tr>";
            }
