    ...
    <table>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='8' class='error-message'>No staff found in ZPBPK department.</td></tr>";
            }
