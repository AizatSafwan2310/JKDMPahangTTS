...
$password = "";
$dbname = "jkdm";
$dbPort = "3307"; // Port connection detail
    ...
    <table>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='8' class='error-message'>No staff found</td></tr>";
            }
            ?>
        </tbody>
    </table>
